...
public class AlunoService {
    ...
    public List<MatriculaDTO> listarMatriculas(Long id){
        Aluno aluno = alunoRepository.findById(id).orElseThrow(()->new EntityNotFoundException("Aluno not found"));
    ...
    public AlunoResponse atualizar(Long id, AlunoRequest request){
        ...
        Aluno a=alunoRepository.findById(id).orElseThrow(()->new EntityNotFoundException("Aluno not found"));
